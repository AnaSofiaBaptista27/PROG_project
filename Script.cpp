...
namespace prog
{
    ...
    void Script::fill(rgb_value r1, rgb_value g1, rgb_value b1, int w, int h, int x, int y)
    {
        ...
        // Percorre cada pixel do retângulo.
    ...
    void Script::add(const string &filename, rgb_value r, rgb_value g, rgb_value b, int x, int y)
    {
        ...
        Image *new_image = loadFromPNG(filename);      // Guarda na memória uma imagem guardada num ficheiro PNG.
        int nw = new_image->width();       // Obtém a largura da imagem.
        int nh = new_image->height();      // Obtem a altura da imagem.
        ...
        // Elimina a imagem descarregada do ficheiro PNG.
        delete new_image;
    }
    ...
    void Script::crop(int x, int y, int w, int h)
    {
        ...
        Image *croppedImage = new Image(w, h);  // Cria uma nova imagem para guardar os pixeis cortados.
        ...
        // Elimina a imagem original se existir.
        delete image;

        // Atribui a imagem cortada à imagem original.
        image = croppedImage;
    }
    void Script::rotate_left()
    {
        ...
        int width_ = image->width();       // Obtém a largura da imagem.
        int height_ = image->height();     // Obtem a altura da imagem.
...
void Script::median_filter(int ws) 
    {
        // Aplicar um "median filter" em quadrados de ws>=3 na imagem atual.

        int width_ = image->width();       // Obtém a largura da imagem.
        int height_ = image->height();     // Obtem a altura da imagem.

        // Cria uma nova imagem para guardar a imagem com o "median filter" aplicado.
        ...
        // Substituir a imagem atual pela imagem já com o filtro aplicado.
        delete image;
        image = filtImage;
    }
